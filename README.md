...
|---|---|---|
| Mon | **Lower** | Legs early, maximum distance before Saturday's long run |
...
The app does not enforce this. Miss a day, train out of order, train on a Sunday instead — the schedule engine follows what you actually do (see *How the schedule works*).
...
| Lift | Heavy | Volume |
|---|---|---|
| Incline barbell bench | Wed — top set 4–6, then 3×6 @ 85% | Fri — 3×8–12 |
| Overhead press | Sun — top set 4–6, then 3×6 @ 85% | Wed — 3×8–10 |
| Weighted pull-up | Fri — top set 4–6, then 3×6 @ 85% | Sun — 3×6–8 |
